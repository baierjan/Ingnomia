...
void NewGameSettings::save()
{
	...
	IO::saveFile( GAME_DATA_FOLDER + "/settings/newgame.json", sd );
...
void NewGameSettings::loadEmbarkMap()
{
	...
	QJsonDocument sd;
	if ( !IO::loadFile( GAME_DATA_FOLDER + "/settings/newgame.json", sd ) )
	{
...
void NewGameSettings::loadPresets()
{
	...
	ok = IO::loadFile( GAME_DATA_FOLDER + "/settings/userpresets.json", sd );
	if ( ok )
	{
		m_userPresets.clear();
...
void NewGameSettings::saveUserPresets()
{
	...
	IO::saveFile( GAME_DATA_FOLDER + "/settings/userpresets.json", sd );
}
